...
install_flutter_as_normal_user(){
  ...
  proot-distro login --user $user archlinux -- curl https://storage.googleapis.com/flutter_infra_release/releases/stable/linux/flutter_linux_3.3.10-stable.tar.xz | tar -xJf -
